 ...
 * **Authors:** Mauricio Romero-Torres, Alberto Acosta, Ana M. Palacio-Castro, Eric A. Treml, Fernando A. Zapata, David A. Paz-García & James W. Porter
 * Version 3.8
...
*Note:* Year is treated as a factor and not as a continuous variable
...
* (a) Thermally stable regime. 
* (b) Tropical upwelling regime.
* (c) Equatorial upwelling regime. 
* (d) Seasonal regime. 

The smooth line represents the best fit to the time series with a 95% confidence level interval and a span = 0.3.

```{r, message=FALSE, warning=FALSE, fig.height = 8.5, fig.width = 7.5}
library(ggplot2)
library(lemon)
