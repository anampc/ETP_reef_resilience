...
grid.arrange(Figure3a, Figure3b, nrow = 1, widths = c(3.5/5, 1.5/5))
#ggsave(file="Figure_3.svg", dpi = 300, plot=grid.arrange(Figure3a, Figure3b, widths = c(3.5/5, 1.5/5), nrow = 1), 
    #3width = 10, height = 3.6, units = "in")
